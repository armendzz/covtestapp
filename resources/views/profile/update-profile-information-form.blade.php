<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
         ...
         <!-- Labor ID -->
         <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="hersteller" value="{{ __('Test Hersteller') }}" />
            <x-jet-input id="hersteller" type="text" class="mt-1 block w-full" wire:model.defer="state.hersteller" />
            <x-jet-input-error for="hersteller" class="mt-2" />
        </div>
    </x-slot>
